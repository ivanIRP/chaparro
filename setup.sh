#!/bin/bash
# =========================================================
# SCRIPT MAESTRO INTERACTIVO - PROYECTO REDES
# =========================================================

echo "==========================================="
echo "   CONFIGURADOR AUTOMÁTICO DE ROUTERS      "
echo "==========================================="
read -p "Introduce el número del Router (0-5): " ID

echo "--- Configurando Router $ID ---"

# --- 1. APERTURA DE SEGURIDAD (Rutas Absolutas) ---
...
# --- 2. RUTAS DE KERNEL (Bypass de VirtualBox) ---
if [ $ID -eq 1 ]; then
...
echo "-------------------------------------------"
echo "¡Router $ID configurado con éxito!"
echo "-------------------------------------------"