#!/bin/bash
# Auto-configurador de Routers Debian 12 (Topologia IPv6 sobre IPv4) FINAL 2.0
...
# Preparar archivo FRR base (Se quito 'no ipv6 forwarding')
...
EOF
  ...
  1)
    ...
    # NUEVO: Forzar Link-Local en el tunel para evitar drop de pings
