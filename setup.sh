...
echo "[*] Limpiando el desastre anterior..."
...
echo "================================================="
echo "   CONFIGURACIÓN FINAL (RUTAS COMPLETAS + IPIP6) "
echo "================================================="
...
case $OPC in
    ...
    1) # R1
        ...
        # Túnel IPIP6 hacia R3 (IPv4 sobre IPv6 - ¡Más estable que GRE!)
        ...
        $VTY -c "conf t" \
             ...
             -c "ipv6 route 2000::8/125 2000::1a" \
             -c "ipv6 route 2000::10/125 2000::1a" \
    ...
    3) # R3
        ...
        $VTY -c "conf t" \
             ...
             -c "ipv6 route 2000::10/125 tunR4" -c "exit" -c "write"
        ;;
    4) # R4
...
echo "[!] Listo. Inyectado con éxito en R$OPC."