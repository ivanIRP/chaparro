...
# 1. Validar que se ejecute como root
if [[ $EUID -ne 0 ]]; then 
...
echo "[*] Limpiando el sistema y habilitando reenvío de paquetes..."
# Cargar módulos del kernel para túneles
...
# Limpieza profunda para evitar conflictos con intentos anteriores
...
# Borrar la configuración vieja de FRR
...
case $OPC in
    0) 
        ...
        # Túnel SIT hacia R1 (IPv6 sobre IPv4)
    ...
    5) 
        ...
        ;;
    *)
        echo "Opción no válida. Debes elegir entre 0 y 5."
        exit 1
        ;;
esac
